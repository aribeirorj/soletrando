...
| **Reconhecimento de letras** | `speech/letterRecognition.ts` | Vosk rodando no navegador, offline, com o vocabulário restrito aos nomes das letras em inglês. Se não houver suporte, permissão do microfone ou modelo, só mostra um aviso e o jogo segue igual. No Soletrando não há reconhecimento: o modelo pequeno em português não reconhece os nomes das letras (`docs/spikes/2026-09-19-voz-em-portugues.md`), então o Modo de correção é sempre `botoes`. |
